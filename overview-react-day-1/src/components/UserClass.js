...
class UserClass extends React.Component{
    constructor(props){ //to get the props in class we need constructor.
        ...
        this.state = { //This is my state varaiable similar to const [count] = useState(0).
            count:0
        }
        ...
        return(
            <div className="userCard">
                ...
                <button onClick={()=>{
                    ...
                    this.setState({ //This setState() function takes state variable object: which is responsible for update in state.
